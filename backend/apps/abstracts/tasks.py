...
from apps.main.models import Article, Category, Tag, Comment, Reaction
...
def cleanup_soft_deleted_records(self, retention_days: int = 30) -> str | Exception:
...
def collect_content_statistics(self) -> dict[str, int]:
    stats = {
