...
class TestTagViewSet:
    ...
    def test_list_returns_list(self, api_client, tag: Tag) -> None:
        """Response body is a plain list."""
        response = api_client.get("/api/tags/")
        assert isinstance(response.data, list), "Tag list must be a plain list"

    def test_retrieve_returns_200(self, api_client, tag: Tag) -> None:
    ...
    def test_delete_by_admin_returns_204(self, admin_client, tag: Tag) -> None:
