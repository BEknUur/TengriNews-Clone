...
class TestCategoryViewSet:
    ...
    def test_retrieve_returns_correct_name(self, api_client, category: Category) -> None:
    ...
    def test_delete_by_admin_returns_204(self, admin_client, category: Category) -> None:
