...
class TestArticleViewSet:
    ...
    def test_list_returns_200(self, auth_client: Any) -> None:
        """GET /api/articles/ returns 200."""
        response = auth_client.get("/api/articles/")
        assert response.status_code == 200

    def test_list_has_pagination_and_data(self, auth_client: Any, article: Any) -> None:
    ...
    def test_cursor_pagination(self, auth_client: Any, article: Any) -> None:
    ...
    def test_page_pagination(self, auth_client: Any, article: Any) -> None:
    ...
    def test_limit_pagination(self, auth_client: Any, article: Any) -> None:
    ...
    def test_default_pagination_is_cursor(self, auth_client: Any, article: Any) -> None:
    ...
    def test_retrieve_returns_200(self, auth_client: Any, article: Article) -> None:
        """GET /api/articles/{id}/ returns 200."""
        response = auth_client.get(f"/api/articles/{article.pk}/")
        assert response.status_code == 200

    def test_retrieve_not_found(self, auth_client: Any) -> None:
        """GET /api/articles/9999/ returns 404."""
        response = auth_client.get("/api/articles/9999/")
        assert response.status_code == 404

    def test_create_article(self, auth_client: Any, category: Category) -> None:
    ...
    def test_update_article(self, auth_client: Any, article: Article) -> None:
    ...
    def test_delete_article(self, auth_client: Any, article: Article) -> None:
